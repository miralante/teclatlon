...
(function () {
  ...
  App.i18n.register({
    ...
    "responsibleP1": 'Teclatlon es una aplicación desarrollada de forma independiente. No hay ningún servidor propio que reciba o almacene tus datos: la aplicación es un conjunto de páginas estáticas que se ejecutan en tu navegador, en tu propio ordenador.',
...
"dataItem3Label": "Rachas e insignias",
    ...
    "contactP2": 'Última actualización: 31 de julio de 2026.',

    "footerApp": 'Ir a Teclatlon'
  }, 'es');
})();
