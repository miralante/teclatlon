...
| 💻 **Build**: developer | Maintains the keyboard layouts, lessons, and the SW | Edits `data.js` (the `LESSONS`, `WORDS`, `NUMPAD` arrays), `app.js`, `sw.js`, and `strings.<locale>.js`; runs [`scripts/check.js`](../../scripts/check.js), bumps `VERSION` in `sw.js`, and deploys. | [`CLAUDE.md`](../../CLAUDE.md) · [`technical.md`](technical.md) · [`technical.md` §8](technical.md#8-suite-pattern-how-every-app-of-miralante-is-built) |
...
| 💻 Developer | [`CLAUDE.md`](../../CLAUDE.md) · [`technical.md`](technical.md) · [`technical.md` §8](technical.md#8-suite-pattern-how-every-app-of-miralante-is-built) |
