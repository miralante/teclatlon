...
| 💻 **Build**: developer | Maintains the keyboard layouts, lessons, and the SW | Edits `data.js` (the `LESSONS`, `WORDS`, `NUMPAD` arrays), `app.js`, `sw.js`, and `strings.<locale>.js`; runs [`scripts/check.js`](../../scripts/check.js), bumps `VERSION` in `sw.js`, and deploys. | [`CLAUDE.md`](../../CLAUDE.md) · [`technical.md`](technical.md) · [`suite-pattern.md`](suite-pattern.md) |
...
| 💻 Developer | [`CLAUDE.md`](../../CLAUDE.md) · [`technical.md`](technical.md) · [`suite-pattern.md`](suite-pattern.md) |
