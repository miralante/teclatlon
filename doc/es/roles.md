...
| 💻 **Construcción**: desarrollador/a | Mantiene los layouts de teclado, las lecciones y el SW | Edita `data.js` (los arrays `LESSONS`, `WORDS`, `NUMPAD`), `app.js`, `sw.js` y `strings.<locale>.js`; ejecuta [`scripts/check.js`](../../scripts/check.js), sube el `VERSION` en `sw.js` y despliega. | [`CLAUDE.md`](../../CLAUDE.md) · [`tecnico.md`](tecnico.md) · [`tecnico.md` §8](tecnico.md#8-patrón-de-la-suite-cómo-se-construye-cada-app-de-miralante) |
...
| 💻 Desarrollador/a | [`CLAUDE.md`](../../CLAUDE.md) · [`tecnico.md`](tecnico.md) · [`tecnico.md` §8](tecnico.md#8-patrón-de-la-suite-cómo-se-construye-cada-app-de-miralante) |
